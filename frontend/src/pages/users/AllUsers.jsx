  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-end mb-4">
        <label htmlFor="roleFilter" className="mr-2 text-lg font-medium">Filter by Role:</label>
        <select
          id="roleFilter"
          value={roleFilter}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredUsers.map((user) => (
          <div key={user._id} className="relative bg-white shadow-md rounded-lg p-4 border border-gray-300 overflow-hidden">
            <AiFillDelete
            ...
            <div className="text-start mt-4 break-words">
              ...
              <p className="text-gray-600"><span className='text-lg font-semibold'>Email:</span> {user.email}</p>
              <p className="text-gray-500"><span className='text-lg font-semibold'>Role:</span> {user.role}</p>
            </div>
          </div>
        ))}
      </div>
